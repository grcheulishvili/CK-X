...
```bash
curl -fsSL https://raw.githubusercontent.com/grcheulishvili/CK-X/master/scripts/install.sh | sudo bash
```
...
1. Download the installation script:
   - Linux/macOS: [install.sh](https://raw.githubusercontent.com/grcheulishvili/CK-X/master/scripts/install.sh)
   - Windows: [install.ps1](https://raw.githubusercontent.com/grcheulishvili/CK-X/master/scripts/install.ps1)
...
2. Visit our [GitHub Issues](https://github.com/grcheulishvili/CK-X/issues)
